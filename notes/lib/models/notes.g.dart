...
void _noteSerialize(
  ...
  writer.writeBool(offsets[4], object.isDeletedLocally);
...
Note _noteDeserialize(
  ...
  final object = Note(
    ...
    isDeletedLocally: reader.readBoolOrNull(offsets[4]) ?? false,
...
extension NoteQueryWhereSort on QueryBuilder<Note, Note, QWhere> {
  QueryBuilder<Note, Note, QAfterWhere> anyLocalId() {
...
extension NoteQueryWhere on QueryBuilder<Note, Note, QWhereClause> {
  QueryBuilder<Note, Note, QAfterWhereClause> localIdEqualTo(Id localId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> localIdNotEqualTo(Id localId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> localIdGreaterThan(Id localId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> localIdLessThan(Id localId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> localIdBetween(
    Id lowerLocalId,
    Id upperLocalId, {
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> isDeletedLocallyEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> localIdEqualTo(Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'localId',
        value: value,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> localIdGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> localIdLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> localIdBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortByIsDeletedLocally() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeletedLocally', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByIsDeletedLocallyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByIsDeletedLocally() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeletedLocally', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByIsDeletedLocallyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeletedLocally', Sort.desc);
    });
  }
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByLocalId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'localId', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByLocalIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctByIsDeletedLocally() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  QueryBuilder<Note, int, QQueryOperations> localIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, bool, QQueryOperations> isDeletedLocallyProperty() {
    return QueryBuilder.apply(this, (query) {
